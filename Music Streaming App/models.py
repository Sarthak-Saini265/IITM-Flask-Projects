...
class songs(db.Model):
    ...
    artist = db.Column(db.String(50), default="Anonymous", unique=False, nullable=False)
    genre = db.Column(db.String(40), default="Unknown", unique=False, nullable=False)
    uploaded_by = db.Column(db.String(30), unique=False, nullable=False)
